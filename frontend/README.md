Jobly is a mock job application site that allows users to navigate companies and jobs and apply to them. 
Back end is built in node.js using express. 
Front end is React.

Commands -
  Start front end - npm start
  Start back end - nodmon server.js
